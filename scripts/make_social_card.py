...
ax.set_title("Econ Light Monitor — Headline Index", color="white")
...
fig.text(0.08, 0.38, "Top Brightening Regions", fontsize=14, weight="bold", color="white")
...
fig.text(0.55, 0.38, "Top Dimming Regions", fontsize=14, weight="bold", color="white")
...
fig.text(0.08, 0.08, f"Current Headline Index: {latest_idx:.1f}", fontsize=16, weight="bold", color="white")
